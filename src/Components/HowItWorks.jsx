            ...
            <div className="relative w-full max-w-7xl sm:px-5 px-2">
                ...
                {steps?.map((step, index) => (
                    ...
                    >
                        ...
                        {/* Step Card */}
                        <div
                            className={`bg-white/10 border border-white/10 rounded-lg p-4 sm:p-6 shadow-lg w-[35%] text-left relative 
              ...
              before:border-b-2 before:border-dashed before:border-white before:w-[47%]`}
                        >
                            ...
                            <p className="sm:text-lg text-base font-semibold mt-2">
                                {step.title}
                            </p>
