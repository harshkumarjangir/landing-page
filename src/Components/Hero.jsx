...
//               key={index}
//               href={btn.link}
//               className={`py-3 px-8 rounded-xl font-medium transition-all duration-300 ${index === 0
//                   ? "bg-[#1163FB] hover:bg-white/20 border border-[#1163FB] hover:border-white text-white"
//                   : "bg-white/20 hover:bg-[#1163FB] text-white border border-white/20"
//                 }`}
//             >
//               {btn.text}
//             </Link>
